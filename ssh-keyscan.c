...
///// OQS_TEMPLATE_FRAGMENT_ASSIGN_KEX_GEN_CLIENT_START
	...
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HPS40961229_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HRSS701_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HRSS1373_SHA512] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_NTRUPRIME_NTRULPR1277_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRUPRIME_SNTRUP1277_SHA512] = kex_gen_client;
#ifdef WITH_OPENSSL
#ifdef OPENSSL_HAS_ECC
	...
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HPS40961229_ECDH_NISTP521_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HRSS701_ECDH_NISTP384_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRU_HRSS1373_ECDH_NISTP521_SHA512] = kex_gen_client;
	...
	c->c_ssh->kex->kex[KEX_KEM_NTRUPRIME_NTRULPR1277_ECDH_NISTP521_SHA512] = kex_gen_client;
	c->c_ssh->kex->kex[KEX_KEM_NTRUPRIME_SNTRUP1277_ECDH_NISTP521_SHA512] = kex_gen_client;
#endif /* OPENSSL_HAS_ECC */
#endif /* WITH_OPENSSL */
