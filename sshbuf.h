...
#if SIZEOF_SIZE_T == 4
#define sshbuf_get_size(b, vp) sshbuf_get_u32((b), (u_int32_t *)(vp))
#define sshbuf_put_size(b, v) sshbuf_put_u32((b), (u_int32_t)(v))
#else
#define sshbuf_get_size(b, vp) sshbuf_get_u64((b), (u_int64_t *)(vp))
#define sshbuf_put_size(b, v) sshbuf_put_u64((b), (u_int64_t)(v))
#endif
